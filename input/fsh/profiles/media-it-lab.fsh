...
* operator only Reference(PractitionerItcore or PractitionerRoleItcore or OrganizationItCore or CareTeam or PatientItcore or DeviceRefertoLabIt or RelatedPerson)
